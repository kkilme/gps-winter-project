...
public class HeroInstanceData
{
    ...
    private string _customName; // 플레이어가 설정한 Hero의 이름
    public string CustomName { get => _customName; set { _customName = value; OnNameChanged?.Invoke(this); } }
    ...
    public Action<HeroInstanceData> OnNameChanged { get; set; } // 이름이 변경될 때 호출되는 이벤트
