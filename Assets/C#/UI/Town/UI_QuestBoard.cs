...
{   
    ...
    private class UI_QuestBoard_Quest : UI_Base
    {
        ...
        {   
            ...
            {
                GetButton(Buttons.StartButton).gameObject.BindEvent(OnStartButtonClicked, UIEvent.Click);
            }
        }
        ...
        {
            Enum.TryParse(_quest.QuestData.AreaName, out AreaName areaName);
    ...
    private class UI_Quest : UI_Base
    {
        ...
        public override void Init()
        {
            ...
            GetButton(Buttons.CancelButton).gameObject.BindEvent(OnClickedCancelButton, UIEvent.Click);
        }
        ...
        public void SetQuest(Quest _quest)
        {
            ...
            GetButton(Buttons.AcceptButton).gameObject.BindEvent(OnClickedAccpetButton, UIEvent.Click);
        }
    ...
    private void OnEnable()
    {
        ...
        foreach (Data.QuestData questData in Managers.DataMng.QuestDataDict.Values)
        {
            ...
            //{
            //    questBoard_Quest.gameObject.BindEvent(OnClicked, UIEvent.Click);
            //}
            #endregion
