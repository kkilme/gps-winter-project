...
public class Test : MonoBehaviour
{
    ...
    //    {
    //        BaseItem item = hero.Bag.StoreItem(ITEM_HEALPOTION_ID);
    ...
    //        weapon.SetInfo(KNIGHT_START_WEAPON_ID);
    //        hero.EquipWeapon(weapon);
    //    }
    //    else if (Input.GetKeyDown(KeyCode.Alpha5))
    //    {
    //        Armor body = new SampleBody1();
    //        body.SetInfo(ARMOR_SAMPLEBODY1_ID);
    //        hero.EquipArmor(body);
    //    }
    //    else if (Input.GetKeyDown(KeyCode.Alpha6))
    //    {
    //        Armor body = new SampleBody2();
    //        body.SetInfo(ARMOR_SAMPLEBODY2_ID);
    //        hero.EquipArmor(body);
    //    }
    //}
}